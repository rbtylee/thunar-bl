...
#endif
{
  ...
  "tor /><menuitem action=\"detach-tab\" /><menuitem action=\"switch-next-"
  "tab\" /><menuitem action=\"switch-previous-tab\" /><separator /><menuit"
  "em action=\"close-tab\" /></popup><toolbar name=\"location-toolbar\"><p"
  "laceholder name=\"placeholder-history-actions\" /><toolitem action=\"op"
  "en-parent\" /><toolitem action=\"open-home\" /></toolbar></ui>"
};

static const unsigned thunar_window_ui_length = 3322u;
